    ...
    <div>
      <div className='flex items-center pb-60 justify-center flex-col m-3 sm:m-0'>
        <Image
          ...
          height={500}
          src='/hero-image.png'
          className='z-10 h-96 object-contain'
          alt='display image on homepage'
        />
        <p
          className={`${myFont.className} text-center text-2xl  inline max-w-xl`}
        >
          Unlock your language potential with our{" "}
          <span className='text-green-500'>bite-sized</span> course designed for
          travelers!
        </p>
