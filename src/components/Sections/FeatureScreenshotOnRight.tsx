...
const dotPointsPostive = [
  {
    name: "",
    description: "Do you find yourself jet-setting to a foreign place with NO clue how to speak the language?",
    icon: orderOneGreen,
  },
  {
    name: "",
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              <p className={`${myFont.className} mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl`}>
                Is this course for you?
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">If you can answer &quot;yes&quot; to both of these:</p>
              ...
              <p className="mt-6  font-semibold text-lg leading-8 text-green-600">This course is for you!</p>
            </div>
            <div className="lg:max-w-lg mt-20">
              <p className={`${myFont.className} mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl`}>
                Should I ditch this language course?
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">If you can answer &quot;yes&quot; to any one of these:</p>
              <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
              ...
              <p className="mt-6  font-semibold text-lg leading-8 text-red-600">This course is not for you.</p>
            </div>
          </div>
