...
} from "@/helpers/calculateAverageLessonScore";
        ...
        if (lesson.completedActivities === lesson.totalActivities) {
          ...
          if (
            courseStats.totalCourseLessons ===
              courseStats.totalCourseLessonsCompleted &&
            courseStats.totalCourseAssessmentsCompleted ===
...
export const selectUser = (state: RootState) =>
  state.userReduxState.user;
export const selectCurrent = (state: RootState) =>
  state?.userReduxState?.current;
export const selectUnit = (state: RootState) =>
  state.userReduxState?.user?.iSpeakItalian;
// Other code such as selectors can use the imported `RootState` type
export const selectMessage = (state: RootState) =>
  state?.userReduxState?.messages;
export const selectExitDisplay = (state: RootState) =>
  state?.userReduxState?.messages?.exitDisplay;
